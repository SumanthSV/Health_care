              ...
              <div className="text-white animate-slide-in-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  ...
                  <Link href="/api/auth/login">
                    <Button 
                      size="large" 
                      className="premium-button-outline !text-white !border-white/30 hover:!bg-white/10 !font-semibold !h-14 !px-8 !rounded-xl backdrop-blur-sm transition-all duration-300 hover-lift"
                    >
                      Sign In
                    </Button>
                  </Link>
                ...
                <div className="flex items-center space-x-6 text-white/80">
                  <div className="flex items-center">
                    ...
                    <Text className="text-white/80">HIPAA Compliant</Text>
                  </div>
                  <div className="flex items-center">
                    <SafetyOutlined className="mr-2 w-4 h-4" />
                ...
                <div className="relative z-10 bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 hover-lift">
                  <div className="space-y-6">
                    ...
                    <div className="bg-white/90 rounded-xl p-4 flex items-center animate-scale-in">
                      ...
                      <div>
                        <Text strong className="text-gray-800">Within Work Area</Text>
                        <br />
      ...
      <footer className="bg-gray-900 text-white py-12 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2024 HealthShift. All rights reserved. Built for healthcare professionals.
            </p>
          </div>
        </div>
      </footer>

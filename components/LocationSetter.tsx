              ...
              {[
                {
                  ...
                  description: "Use the search bar for precise location targeting of hospitals, clinics, or specific addresses",
                  color: "blue"
                },
                {
                  step: 2,
                  title: "Select on Map",
                  description: "Click anywhere on the interactive map to manually set your work location",
                  color: "green"
                },
                {
                  step: 3,
                  title: "Use Current Location",
                  description: "Automatically detect your current position for immediate setup",
                  color: "purple"
                },
                {
                  step: 4,
                  title: "Adjust Coverage",
                  description: "Fine-tune the radius to define the exact work zone perimeter",
                  color: "orange"
                },
                {
                  step: 5,
                  title: "Save & Activate",
                  description: "Staff can only clock in when inside the defined blue circle",
                  color: "red"
                }
              ].map((item, index) => (
                <div key={index} className="flex items-start space-x-3 group">
                  <div className={`w-8 h-8 bg-${item.color}-100 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform duration-200`}>
